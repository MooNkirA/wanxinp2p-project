...
import com.moon.wanxindepository.common.constant.PreTransactionCode;
...
import com.moon.wanxindepository.model.DepositoryResponse;
...
import com.moon.wanxindepository.service.ProjectService;
import com.moon.wanxindepository.service.TenderService;
...
public class ServiceController {
    ...
    public DepositoryResponse<CreateProjectResponse> createProject(@RequestParam String serviceName, @RequestParam String platformNo,
                                                                   @RequestParam String signature, @RequestParam String reqData) {
    ...
    public DepositoryResponse<ModifyProjectResponse> modifyProject(@RequestParam String serviceName, @RequestParam String platformNo,
                                                                   @RequestParam String signature, @RequestParam String reqData) {
    ...
    public DepositoryResponse<UserAutoPreTransactionResponse> authorizeAutoPreTransaction(
            @RequestParam String serviceName, @RequestParam String platformNo,
            @RequestParam String signature, @RequestParam String reqData) {
    ...
    public DepositoryResponse<ConfirmLoanResponse> confirmLoan(@RequestParam String serviceName, @RequestParam String platformNo,
                                                               @RequestParam String signature, @RequestParam String reqData) {
    ...
    public DepositoryResponse<ConfirmRepaymentResponse> confirmRepayment(@RequestParam String serviceName, @RequestParam String platformNo,
                                                                         @RequestParam String signature, @RequestParam String reqData) {
